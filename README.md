...
Link de visualização: [Portal do Motorista](https://euoryan.com/portaldomotorista/)

<br/>

## Bem-vindo ao Portal do Motorista!
Hey! 👋 Que bom ter você por aqui! Este projeto foi criado para facilitar a vida dos motoristas, oferecendo recursos, guias e ferramentas essenciais para quem está na estrada.
...
const techStack = {
    ...
    dedicação: "Para todos os motoristas ❤️"
}
```
